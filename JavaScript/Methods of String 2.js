...
1
1
We can see, str.index("e") equals str.lastIndexOf("e"), because there is only one "e" in str. Look at the following example:
...
function firstToLast(str,c){
  return str.indexOf(c)==-1||str.lastIndexOf(c)==-1?-1:str.lastIndexOf(c)-str.indexOf(c);
}